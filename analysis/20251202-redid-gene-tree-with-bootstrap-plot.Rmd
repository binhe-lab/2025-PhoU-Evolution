...
```{r}
tip_colors = c("PhoU" = "#cdb45a", "PitR" = "#49b8d1")
```
...
ggtree(gene_tree_LG1, layout = "equal_angle") +
  ...
  scale_color_manual("Group", values = tip_colors) +
  #guides(color = guide_legend(byrow = TRUE)) +
  theme(legend.position = c(0.12, 0.13),
        legend.title = element_text(size = rel(1.2)),
        legend.text = element_text(size = rel(1.2)),
       )
ggsave("../output/gene-tree/20251202-PhoU-PitR-select-raxml-PROTGAMMA-LG-best-ML-tree.pdf",  width = 8, height = 8)
```
